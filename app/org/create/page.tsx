...
/**
 * FASE 54: CREATE ORGANIZATION PAGE
 */
      ...
      <div className="flex-1 ml-64 pt-14 overflow-y-auto">
        <div className="max-w-2xl mx-auto p-8">
          ...
          <div className="flex items-center gap-4 mb-8">
            ...
            <div>
              <h1 className="text-3xl font-black text-white">Criar Organização</h1>
          ...
          <div className="mt-8 p-4 rounded-xl bg-zinc-900/50 border border-zinc-800">
            <h4 className="font-medium text-white mb-2">O que acontece depois?</h4>
            <ul className="text-sm text-zinc-400 space-y-1">
              <li>• Serás o Owner da organização</li>
              <li>• Podes convidar jogadores para a tua equipa</li>
              <li>• Participa em torneios e praccs para ganhar pontos de ranking</li>
              <li>• Publica notícias na página da tua org</li>
            </ul>
          </div>
        </div>
      </div>
